...
SUB = "Deluxe Edition — The Complete History, with Fifty Hands-On Tone Lessons"
...
ORDER = [
    ("00-front-matter.md", "Front Matter"), ("01-the-electric-signal.md", "Part I: Foundations"),
    ("02-anatomy-of-an-amplifier.md", "Part I: Foundations"), ("03-the-language-of-tone.md", "Part I: Foundations"),
    ("04-pickups-wood-and-truth.md", "Part I: Foundations"), ("05-frying-pan-to-charlie-christian.md", "Part II: Birth of Amplification"),
    ("06-leo-fender-and-the-tweed-era.md", "Part II: Birth of Amplification"), ("07-the-tweed-bassman.md", "Part II: Birth of Amplification"),
    ("08-gibson-valco-american-combo.md", "Part II: Birth of Amplification"), ("09-danelectro-supro-cheap-genius.md", "Part II: Birth of Amplification"),
    ("10-marshall-birth-of-the-stack.md", "Part III: The British Invasion"), ("11-vox-ac30-chime-and-jangle.md", "Part III: The British Invasion"),
    ("12-fender-blackface-brownface.md", "Part III: The British Invasion"), ("13-hiwatt-and-the-command-sound.md", "Part III: The British Invasion"),
    ("14-tremolo-and-vibrato.md", "Part IV: The First Effects"), ("15-spring-reverb-surf-and-space.md", "Part IV: The First Effects"),
    ("16-the-fuzz-explosion.md", "Part IV: The First Effects"), ("17-the-wah-wah.md", "Part IV: The First Effects"),
    ("18-treble-booster-british-lead.md", "Part IV: The First Effects"), ("19-the-univibe.md", "Part V: The Pedal Revolution"),
    ("20-the-big-muff.md", "Part V: The Pedal Revolution"), ("21-mxr-and-the-phase-90.md", "Part V: The Pedal Revolution"),
    ("22-the-tube-screamer.md", "Part V: The Pedal Revolution"), ("23-echo-and-delay.md", "Part V: The Pedal Revolution"),
    ("24-chorus-flange-modulation-boom.md", "Part V: The Pedal Revolution"), ("25-the-compressor.md", "Part V: The Pedal Revolution"),
    ("26-mesa-boogie-high-gain.md", "Part VI: High Gain & the Modern Era"), ("27-hot-rodded-marshall-brown-sound.md", "Part VI: High Gain & the Modern Era"),
    ("28-rack-systems-big-80s-rig.md", "Part VI: High Gain & the Modern Era"), ("29-soldano-bogner-boutique.md", "Part VI: High Gain & the Modern Era"),
    ("30-grunge-and-the-return-of-fuzz.md", "Part VI: High Gain & the Modern Era"), ("31-digital-modeling.md", "Part VI: High Gain & the Modern Era"),
    ("32-jimi-hendrix.md", "Part VII: Tone in Practice — The Players"), ("33-eric-clapton.md", "Part VII: Tone in Practice — The Players"),
    ("34-jimmy-page.md", "Part VII: Tone in Practice — The Players"), ("35-david-gilmour.md", "Part VII: Tone in Practice — The Players"),
    ("36-eddie-van-halen.md", "Part VII: Tone in Practice — The Players"), ("37-stevie-ray-vaughan.md", "Part VII: Tone in Practice — The Players"),
    ("38-the-edge.md", "Part VII: Tone in Practice — The Players"), ("39-kurt-cobain.md", "Part VII: Tone in Practice — The Players"),
    ("40-modern-blues-torchbearers.md", "Part VII: Tone in Practice — The Players"), ("41-brian-may.md", "Part VII: Tone in Practice — The Players"),
    ("42-tom-morello.md", "Part VII: Tone in Practice — The Players"), ("43-signal-chain-order.md", "Part VIII: Building Your Rig"),
    ("44-gain-staging.md", "Part VIII: Building Your Rig"), ("45-building-the-pedalboard.md", "Part VIII: Building Your Rig"),
    ("46-matching-tone-to-music.md", "Part VIII: Building Your Rig"), ("47-appendix-a-glossary.md", "Appendices"),
    ("48-appendix-b-timeline.md", "Appendices"), ("49-appendix-c-tab-reference.md", "Appendices"), ("50-appendix-d-discography.md", "Appendices"),
]
CH2LESSON = {
...
META_TITLE = "THE SIGNAL CHAIN, Deluxe Edition — Guitar Tone History + 50 Hands-On Lessons"
DESC = ("THE SIGNAL CHAIN Deluxe Edition by Jason Colapietro (Johnny Suede): the complete illustrated "
...
B = [art.cover("Deluxe Edition", TITLE, SUB, AUTHOR, "Johnny Suede Press", A, A2),
     bk.title_page("Deluxe Edition", TITLE, SUB, AUTHOR, EPIGRAPH,
...
html = bk.doc(META_TITLE + " | Jason Colapietro (Johnny Suede)", bk.build_css(THEME, WS),
              "\n".join(B), bk.seo_head(META_TITLE, DESC, KEYWORDS, AUTHOR, "Johnny Suede Press",
                                        SITE + "/THE-SIGNAL-CHAIN-DELUXE.html", SITE + "/preview-9-cover.png"))
